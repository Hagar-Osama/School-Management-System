                                ...
                                <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50" style="text-align: center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-outline-danger btn-sm" data-toggle="modal" data-target="#undoOneUpgrade{{$upgrade->id}}">{{ trans('students.Undelete Student') }}</button>
                                                <button type="button" class="btn btn-outline-success btn-sm" data-toggle="modal" data-target="#Delete_upgradedStudent{{$upgrade->id}}">تخرج الطالب</button>
                                            </td>
                                        </tr>
                                        ...
                                        <div class="modal fade" id="Delete_upgradedStudent{{$upgrade->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <form action="{{route('upgradedStudents.destroy')}}" method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            <p> {{ trans('students.Delete Student Warning') }} {{$upgrade->students->name}}</p>
                                                            <input type="hidden" name="upgrade_id" value="{{$upgrade->id}}">
                                                        </div>
                                                        <div class="modal-footer">
                                                            <div class="modal-footer">
