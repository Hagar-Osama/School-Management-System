...
@toastr_css
@section('title')
{{trans('students.Upgraded Students Management')}}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0"> {{trans('students.Upgraded Students Management')}}</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="{{route('admin.index')}}" class="default-color">{{trans('students.Home')}}</a></li>
                <li class="breadcrumb-item active">{{trans('students.Upgraded Students Management')}}</li>
            </ol>
        </div>
    </div>
</div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <a href="" class="btn btn-info btn-sm" role="button" aria-pressed="true"><i class="fa fa-edit"></i></a>
                                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete_student{{ $upgrade->id }}" title="{{ trans('students.Delete Student') }}"><i class="fa fa-trash"></i></button>
                                                <a href="" class="btn btn-warning btn-sm" role="button" aria-pressed="true"><i class="far fa-eye"></i></a>
                                            </td>
                                        </tr>

                                        <div class="modal fade" id="delete_student{{$upgrade->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                ...
                                                <form action="" method="post">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <input type="hidden" name="student_id" value="{{$upgrade->id}}">
                                                        </div>
