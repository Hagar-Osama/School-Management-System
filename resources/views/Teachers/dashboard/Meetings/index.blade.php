        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                <div class="col-xl-12 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <a href="{{route('zoom.create')}}" class="btn btn-success btn-sm" role="button" aria-pressed="true"> {{trans('meetings.Add Online Class')}}
                            </a>
                            <a href="{{route('indirectZoom.makeMeeting')}}" class="btn btn-primary btn-sm" role="button" aria-pressed="true"> {{trans('meetings.Add Multiple Online Class')}}
                            </a><br><br>
                                ...
                                <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50" style="text-align: center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{route('zoom.destroy')}}" method="post" style="display: inline-block;">
                                                    @csrf
                                                    @method('DELETE')
