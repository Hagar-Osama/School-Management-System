    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="{{route('teacher.dashboard')}}" class="default-color">{{trans('teachers.Home')}}</a></li>
        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <div class="col-xs-12">
                    <div class="col-md-12">
                        <br>
                        <form action="{{route('indirectZoom.storeMeeting')}}" method="post" autocomplete="off">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label> {{trans('meetings.Meeting ID')}} : <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-2">
                            <div class="form-group">
                                <label>  {{trans('meetings.Password')}} : <span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label> {{trans('meetings.Start Url')}} : <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <label>  {{trans('meetings.Join Url')}} : <span class="text-danger">*</span></label>
