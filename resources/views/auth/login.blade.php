            ...
            <div class="row justify-content-center no-gutters vertical-align">
                ...
                <div class="col-lg-4 col-md-6 bg-white">
                    <div class="login-fancy pb-40 clearfix">
                        @if($type == 'student')
                            <h3 style="font-family: 'Cairo', sans-serif" class="mb-30">Student Login Page</h3>
                        @elseif($type == 'parent')
                            <h3 style="font-family: 'Cairo', sans-serif" class="mb-30">Parent Login Page</h3>
                        @elseif($type == 'teacher')
                            <h3 style="font-family: 'Cairo', sans-serif" class="mb-30">Teacher Login Page</h3>
                        @else
                            <h3 style="font-family: 'Cairo', sans-serif" class="mb-30">Admin Login Page</h3>
                        @endif
