...
Route::group(
    ...
    function () {
        Route::get('/', [HomeController::class, 'select'])->name('selectionPage');
        Route::get('/loginForm/{type}', [AuthController::class, 'chooseloginForm'])->name('login.show')->middleware('guest');
